...
(* CONAPP (TYCON "function", [CONAPP (TYCON "argtuple", *)
...
(* <definition of [[processXDef]], which can modify [[unitTests]] and call [[errmsg]]>= *)
            ...
            val _ = op processDef : def  * 'envs -> 'envs
              in  (case xd
                    ...
                    (* Exception handlers for the read-eval-print loop *)
                    (*                                              *)
...
(* Type checking requires an expression or definition, a *)
(* type environment, and a kind environment. Calling *)
(* elabdef[[(]]t, Gamma, Delta[[)]] should return a pair *)
(* (Gamma', s), where \toptt -->Gamma' and s is a string *)
(* that represents the type of the thing defined. [*] *)
(* <boxed values 9>=                            *)
...
(* Unit testing                                 *)
(*                                              *)
(* <unit testing for {\tuscheme}>=              *)
val testEqual = equalpairs
(* <definition of function [[expString]] ((tuscheme))>= *)
fun expString e =
  let fun bracket s = "(" ^ s ^ ")"
    ...
    of (_, 0) => ()  (* no report *)
     ...
     | _ => if npassed = ntests then
               ...
               app print [Int.toString npassed, " of ", Int.toString ntests,
                          " tests passed.\n"]
(* <unit-testing utilities ((tuscheme))>=       *)
  ...
  let fun fail strings = (app eprint strings; eprint "\n"; false)
      fun ty e = typeof (e, Gamma, Delta)
                 handle NotFound x => raise TypeError ("name " ^ x ^
                                                              " is not defined")
      (* <unit-testing utilities that depend on [[ty]]>= *)
      ...
      fun checkTypeChecks (e, tau) =
        ...
        handle TypeError msg => 
               fail ["In (check-type ", expString e, " " ^ typeString tau, "), "
                                                                          , msg]
      (* <definition of function [[checks]] ((tuscheme))>= *)
      ...
      (* <definition of function [[passes]] ((tuscheme))>= *)
