...
/*
 * Visiting a source means visiting its pending unit
 * tests.
 * <ms.c>=
 */
static void visitsource(Source *s) {
...
/*
 * Function [[visitsourcelist]] visits a list of
 * sources.
 * <ms.c>=
 */
static void visitsourcelist(Sourcelist ss) {
 ...
 * open sources with their pending unit tests, the
 * stack, and any machine registers.
 * <ms.c>=
 */
static void visitroots(void) {
