...
(* micro-Scheme, and we also get two new unit tests *)
(* related to types:                            *)
(* <abstract syntax and values for \timpcore>=  *)
...
(* <definition of function [[expString]] ((timpcore))>= *)
fun expString e =
  let fun bracket s = "(" ^ s ^ ")"
    ...
    of (_, 0) => ()  (* no report *)
     ...
     | _ => if npassed = ntests then
               ...
               app print [Int.toString npassed, " of ", Int.toString ntests,
                          " tests passed.\n"]
(* <unit-testing utilities ((timpcore))>=       *)
...
(* <unit-testing utilities that depend on \timpcore\ top-level environments>= *)
      ...
      fun checkFunctionTypePasses (f, tau as FUNTY (args, result)) =
        ...
        in  if eqTypes (args, args') andalso eqType (result, result') then
              ...
              fail ["In (check-function-type ", f, " " ^ funtyString tau, "), ",
                                                                            msg]
      (* <definition of function [[checks]] ((timpcore))>= *)
      ...
      (* <definition of function [[passes]] ((timpcore))>= *)
