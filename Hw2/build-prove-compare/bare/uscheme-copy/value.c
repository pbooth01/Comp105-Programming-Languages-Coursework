...
static Namelist freevars(Exp e, Namelist bound, Namelist free) {
    ...
    case LETX:
        ...
        break;
    /* extra cases for finding free variables in {\uscheme} expressions 726b */
    /* extra cases for finding free variables in {\uscheme} expressions 736b */
    case BREAKX:
        break;
    case CONTINUEX:
        break;
    ...
    case TRY_CATCH:
        ...
        break;
    /* extra cases for finding free variables in {\uscheme} expressions 737 */
    case HOLE:
    case CALLENV:
    case LETXENV:
...
/* helper functions for [[printvalue]] 712a */
...
static void printvalueat(FILE *output, Value v, int depth) {
    ...
    case PAIR:
        fprint(output, "(");
if (v.u.pair.car == NULL) fprint(output, "<NULL>"); else
        printvalueat(output, *v.u.pair.car, depth);
if (v.u.pair.cdr == NULL) fprint(output, " <NULL>)"); else
        printtail(output, *v.u.pair.cdr, depth);
        return;
    case CLOSURE:
